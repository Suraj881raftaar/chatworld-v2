...
*   **System Architecture (system_architecture.md):** Defining Clean Architecture layouts, DDD components boundaries, Redis Pub/Sub message propagation pipelines, and Hono static routing.
